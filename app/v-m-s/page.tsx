...
export default function VisitorManagementSystem() {
  ...
  useEffect(() => {
    if (selectedCategory) fetchFilteredData();
  }, [selectedCategory, filterType, customStart, customEnd, activeVisitorTab]);
